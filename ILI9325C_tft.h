...
/*
  ...
  document ILI9325C_tft_Supported_display_modules_&_controllers.pdf.

  When using 8bit and 16bit display modules there are some 
  requirements you must adhere to. These requirements can be found 
  in the document ILI9325C_tft_Requirements.pdf.
...
class ILI9325C_tft
{
	public:
		ILI9325C_tft();
		ILI9325C_tft(byte model, int RS, int WR,int CS, int RST, int SER=0);
...
/*
      ...
      that might need access to the lower level functions of ILI9325C_tft.
...
extern ILI9325C_tft ILI9325C_TFT;
